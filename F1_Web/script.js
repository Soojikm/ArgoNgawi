        ...
        if (team.namaTeam.toLowerCase().includes(search)) {
            ...
            div.innerHTML = `
                ...
                <div class="stats-box">
                    ...
                    <div><span class="stat-val">${stats.max}</span><span class="stat-lbl">Best Race</span></div>
                    <div><span class="stat-val">${stats.min}</span><span class="stat-lbl">Worst Race</span></div>
                </div>
    ...
    sortedTeams.forEach((team, i) => {
        ...
        const row = `
            <tr>
                ...
                <td>Best: ${stats.max} / Worst: ${stats.min}</td>
            </tr>
        `;
        tbody.innerHTML += row;
    });
...
document.getElementById('raceForm').addEventListener('submit', (e) => {
    ...
    const pen1 = parseInt(document.getElementById('pen1').value) || 0; 

    const pos2 = parseInt(document.getElementById('pos2').value);
    const pen2 = parseInt(document.getElementById('pen2').value) || 0;
