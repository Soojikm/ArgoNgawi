...
- **Update:** Mengubah data profil tim (Livery, Driver, dll), ada opsi menghapus history balapan setelah dilakukkan update
- **Show All:** Menampilkan semua tim beserta data balapannya
...
- **Statistik Tim:** Menghitung Total Poin, Rata-rata, Balapan Poin Tertinggi, dan Balapan Poin Terendah
...
* Nama Tim: `Red Bull Racing` (Program akan menganggap spasi sebagai pemisah untuk input berikutnya)
